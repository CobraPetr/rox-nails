      ...
      <main className="flex flex-col items-center justify-center px-6 py-12 text-center">
        <div className="max-w-md mx-auto space-y-8">
          ...
          <div className="space-y-2">
            <h1 className="text-2xl font-script text-gray-600">
              Willkommen bei
            </h1>
            <h2 className="text-3xl font-script text-gray-600">
              Rox Does Nails.
            </h2>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <Link href="/buchen">
                <Button 
                  size="lg" 
                  className="w-full bg-accent hover:bg-accent/90 text-white font-bold uppercase tracking-wide"
                >
                  Termin Buchen
                </Button>
              </Link>
